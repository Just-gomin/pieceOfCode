...
import com.example.sburredis.sburredis.Aircraft;
...
public class PlaneFinderPoller {
    ...
    private void pollPlanes() {
        ...
        Objects.requireNonNull(redisOperations.opsForValue().getOperations().keys("*")).forEach(ac -> System.out.println(redisOperations.opsForValue().get(ac)));
    }
}
